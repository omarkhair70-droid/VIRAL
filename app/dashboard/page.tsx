  ...
  return (
    <PageShell title="حسابي">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <section className="space-y-2 rounded-xl border bg-white p-4"><p className="text-lg font-semibold">رأيك في البيتا</p><p className="text-sm text-stone-700">لو حاجة مش واضحة أو قابلت مشكلة، ابعتلنا feedback.</p><div className="flex gap-2"><Link href="/feedback" className="inline-flex rounded-lg border px-3 py-1.5 text-sm">ابعت رأيك</Link><Link href="/dashboard/feedback" className="inline-flex rounded-lg border px-3 py-1.5 text-sm">شوف feedback اللي بعته</Link></div></section>
      </div>
    </PageShell>
  );
}
