...
const safetySections = [
  ...
  },
  {
    ...
    points: ["استخدم زر بلّغ من صفحة الحاجة أو الاقتراح أو الصفقة أو البروفايل.", "اكتب تفاصيل واضحة من غير بيانات خاصة.", "لو في خطر حقيقي، وقف التعامل فورًا واتصرف حسب الموقف."],
  },
] as const;
