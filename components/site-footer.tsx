  ...
  return (
    <footer className="hidden border-t border-app-border bg-app-soft/60 py-8 text-center sm:block">
      <div className="mx-auto flex max-w-6xl items-center justify-center gap-5 px-4">
        ...
        <Link className="type-support transition-colors duration-200 hover:text-app-text-primary motion-reduce:transition-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-app-focus focus-visible:ring-offset-2" href="/account-deletion">طلب حذف الحساب</Link>
